...
public class playerall : MonoBehaviour
{
    ...
    public bool isDead = false;        // Ölü durum kontrolü
    ...
    private void Die()
    {
        ...
        Invoke("ReloadScene", 3f); // 2 saniye sonra sahne yeniden yüklenecek
    }
...
//player hasar aldýðýnda enemyden uzaklaþacak
//hasar alma animasyonu gelecek
//scene kodlarý çýkartýlacak